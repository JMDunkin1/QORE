...
It uses the checked-in May-September day-7 GFS and GEFS forecast calendars, keeps idle capital in `US-INDEX-BASKET`, goes long UNG for broad summer heat, short UNG for broad summer coolness, then adds an opposite-direction overreaction fade after qualifying realized UNG moves. The optimizer fails closed if no candidate satisfies both follow/fade and heat/cool side gates.
