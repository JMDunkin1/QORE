...
It uses the checked-in May-September day-7 GFS and GEFS forecast calendars, keeps idle capital in `US-INDEX-BASKET`, goes long UNG only for fresh broad summer heat after a quiet heat-signal window, keeps summer coolness diagnostic, then adds an opposite-direction overreaction fade after qualifying realized UNG moves. The optimizer fails closed if no candidate satisfies both follow/fade and heat-side gates.
